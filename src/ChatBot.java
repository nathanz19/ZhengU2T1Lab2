public class ChatBot {
    ...
    //Talks about their favorite sports
    public void favSports(String sports) {
        System.out.println("I like to watch " + sports + " too!");
    }
    //Asks for your number
    public String cellNumber(String phoneNum) {
        return phoneNum;
    }
}
